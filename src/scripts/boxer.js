...
export class Boxer {
  ...
  update(delta, opponent, currentSecond) {
    this.currentSpeed = Phaser.Math.Linear(this.currentSpeed, this.speed, 0.2);
    const move = (this.currentSpeed * delta) / 1000;

    const actions = this.controller.getActions(this, opponent, currentSecond);
